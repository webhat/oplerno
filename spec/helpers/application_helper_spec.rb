...
describe ApplicationHelper do
  context 'url_prefix' do
    it 'should return the correct http URL' do
      ...
      expect(url_prefix(request)).to eq 'http://remote.example.com:8081'
    end
